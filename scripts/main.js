...
const singers = [
    new Singer('Ariana Grande', './images/ariana.jpg', `Ariana Grande es una destacada cantante, compositora y actriz estadounidense nacida el 26 de junio de 1993 en Boca Ratón, Florida. Se hizo famosa 
    ...
    para millones de fanáticos en todo el mundo.)`, ['7 Rings', 'thank u, next', 'Save Your Tears (With Ariana Grande) (Remix)', 'One Last Time', 'Side to Side'], [2210000000, 1848000000, 1487000000, 1420000000, 1400000000]),
    new Singer('Billie Eilish', './images/billie.jpg', `Billie Eilish es una cantante y compositora estadounidense nacida el 18 de diciembre de 2001 en Los Ángeles, California. Conocida por su estilo
    ...
    de la década.`, ['Bad Guy', 'Therefore I Am', 'Lovely', 'Bellyache', 'You Should See Me In A Crown'], [1970000000, 1000000000, 500000000, 400000000, 300000000]),
    new Singer('Ed Sheeran', './images/ed.jpg', `Ed Sheeran es un cantante, compositor y músico británico nacido el 17 de febrero de 1991 en Halifax, West Yorkshire. Conocido por su estilo
    ...
    un ícono para millones de fanáticos en todo el mundo.`, ['Shape of You', 'Perfect', 'Castle on the Hill', 'Thinking Out Loud', 'Photograph'], [4140200000, 2032020000, 1900300000, 820100000, 640600000]),
    new Singer('Taylor Swift', './images/taylor.jpg', `Taylor Swift es una cantante, compositora y actriz estadounidense nacida el 13 de diciembre de 1989 en Reading, Pennsylvania. Conocida por su
    ...
    fanáticos en todo el mundo.`, ['Love Story', 'Shake It Off', 'Blank Space', 'You Belong With Me', 'Bad Blood'], [3560700000, 2802100000, 1959000000, 876000000, 682300000]),
    new Singer('BTS', './images/bts.jpg', `BTS es un grupo de música pop surcoreano formado por Big Hit Entertainment. El grupo está compuesto por siete miembros: RM, Jin, Suga, J-Hope,
    ...
    mundo.`, ['Dynamite', 'Butter', 'Life Goes On', 'Boy With Luv', 'Fake Love'], [1830000000, 902100000, 898000000, 745000000, 610400000])
];
// Elements
const nameElement = document.getElementById('singer-name');
const imageElement = document.getElementById('singer-image');
const bioElement = document.getElementById('singer-bio');
const songsElement = document.getElementById('singer-songs');
const buttonElement = document.getElementById('singer-button');
let index = 0;
