...
const singers = [
    ...
    para millones de fanáticos en todo el mundo.)`, ['7 Rings', 'thank u, next', 'Save Your Tears (With Ariana Grande) (Remix)', 'One Last Time', 'Side to Side'], [2210000000, 1848000000, 1487000000, 1420000000, 1400000000], 30),
    ...
    de la década.`, ['Bad Guy', 'Therefore I Am', 'Lovely', 'Bellyache', 'You Should See Me In A Crown'], [1970000000, 1000000000, 500000000, 400000000, 300000000], 22),
    ...
    un ícono para millones de fanáticos en todo el mundo.`, ['Shape of You', 'Perfect', 'Castle on the Hill', 'Thinking Out Loud', 'Photograph'], [4140200000, 2032020000, 1900300000, 820100000, 640600000], 33),
    ...
    fanáticos en todo el mundo.`, ['Love Story', 'Shake It Off', 'Blank Space', 'You Belong With Me', 'Bad Blood'], [3560700000, 2802100000, 1959000000, 876000000, 682300000], 34),
    new Singer('Olivia Rodrigo', './images/olivia.jpg', `Olivia Rodrigo es una cantante y actriz estadounidense nacida el 20 de febrero de 2003 en Temecula, California. Conocida por su papel en la serie
    ...
    influencia en la cultura popular la ha convertido en una de las artistas más influyentes de la década.`, ['Drivers License', 'Good 4 U', 'Deja Vu', 'Traitor', 'Brutal'], [1000000000, 500000000, 300000000, 200000000, 100000000], 21)
];
...
for (let i = 0; i < singers.length; i++) {
    ...
    console.log('done');
    singerList === null || singerList === void 0 ? void 0 : singerList.appendChild(singerElement);
}
